...
if (!process.env.MONGO_URI) {
  ...
  console.error (
    'Please make sure your .env file contains the MONGO_URI variable'
  );
  console.error (
...
async function seedDatabase () {
  ...
  try {
    ...
    const sampleConnections = [
      ...
      // Update this connection to use the standardized jpg filename
      {
        ...
        timestamp: '0:15:30',
        screenshot: '/images/screenshots/screenshot-easy-a.jpg', // Changed from .webp to .jpg
      },
      {
    ...
    if (error.message.includes ('ECONNREFUSED')) {
      ...
      console.error (
        '1. The MongoDB connection string in your .env file is incorrect'
      );
      console.error (
        '2. Your MongoDB Atlas cluster has IP restrictions (whitelist your IP)'
      );
      console.error (
        "3. You're trying to connect to a local MongoDB that isn't running"
      );
    }
